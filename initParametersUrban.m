function [file, signal, acq, track, solu, cmn] = initParametersUrban()
%Purpose:
...
%% File parameters
file.fileName       = 'Urban'; 
file.fileRoute      = ['C:\Users\13471\OneDrive\Desktop\AAE6102_Assignment2\Code\',file.fileName,'.dat']; % Change the route of the raw IF data 
% file.fileName       = 'Opensky'; 
% file.fileRoute      = ['C:\data\',file.fileName,'.bin']; % Change the route of the raw IF data 
file.skip        	= 0; %5000;   	
file.fid           	 = fopen(file.fileRoute,'r','ieee-le');
file.skiptimeVT     = 10; %  100; %1000; % when vector tracking begins, unit: ms
...
solu.iniPos	= [22.3198722/180 * pi, 114.209101777778/180 * pi, 3.0]; % data_20180930_KAITOK_dynamic_f 
